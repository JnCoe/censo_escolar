...
```{r eval=FALSE}
# Código R para importar dados do BigQuery (não executado)
query <- "SELECT cnae_2, cbo_2002, COUNT(*) as total FROM `base-dos-dados-316520.rais2018.selecao2019` WHERE vinculo_ativo_3112 = '1' GROUP BY cnae_2, cbo_2002;"
...
```{r}
dici_cnae <- data.table::fread('../dados/dici_cnae.csv', encoding = 'UTF-8')
```
