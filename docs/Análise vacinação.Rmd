...
Com os dados da RAIS computados, vamos passar à análise dos dados do Censo Escolar, para comparar as duas bases.
...
A média de idade pela Rais é 2 anos acima do censo, com uma diferença quase desprezível de 35.257 funcionários a mais. Por esse motivo, usaremos apenas os dados da RAIS.

Para ter certeza, vamos só checar a distribuição por estados:
...
Enquanto não obtemos resposta, no entanto, vamos verificar como esses dados se relacionam com as vacinações.
