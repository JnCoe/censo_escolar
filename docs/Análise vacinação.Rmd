...
```{r}
compilado_mun_total %>%
  arrange(desc(compilado_mun_total))
```
...
Se desconsiderarmos inclusive o agrupamento por município, podemos obter o número de 1.654.446 docentes em todo o país ao executar o código abaixo:
